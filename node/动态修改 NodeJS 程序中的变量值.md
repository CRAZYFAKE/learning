...
1. 本文相关的源码在： [https://github.com/wyvernnot/interference_demo](https://github.com/wyvernnot/interference_demo);
2. 如果你也对 Debugger 协议感兴趣，可以安装 oneapm-debugger 这个工具，它可以帮助你查看 Debug 过程中所有实际发送的数据。 [oneapm-debugger](https://www.npmjs.com/package/oneapm-debugger)
